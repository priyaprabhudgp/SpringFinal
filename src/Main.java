/**
 * Printwriter Class to write stuff to the score file
 * Scanner for user input
 * FileWriter and IOexception to append stuff instead of replacing
 */
...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        //Loops game until final destination reached
        while (inPlay)
        {
            trail.DisplayChoices(leader);

             if(trail.Locations[trail.CurrentStop].equals("Volterra, Italy") )
            {
                System.out.println("Congratulations! You guys completed this trip under "+leader.name+"'s lead!");
...
/**
 * Assigns Person to specific type
 * @return recursive - keep repeating until user selects which type of person
